...
let myPin = 12345;
let myBalance = 25000;
let pinAnswer = await inquirer.prompt({ message: "Please enter your pincode",
    type: "number",
    name: "pincode",
});
if (pinAnswer.pincode === myPin) {
    console.log("your pincode is correct");
    let operatorAnswer = await inquirer.prompt({ message: "Select an operator.",
        type: "list",
        name: "operator",
    ...
    if (operatorAnswer.operator === "check bal") {
        ...
        let amountAnswer = await inquirer.prompt({ message: "Enter your amount",
            type: "number",
            name: "amount",
        });
